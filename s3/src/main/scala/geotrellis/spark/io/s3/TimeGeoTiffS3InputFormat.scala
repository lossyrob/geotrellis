...
object TimeGeoTiffS3InputFormat {
...
/** Read single band GeoTiff from S3
  ...
  */
class TimeGeoTiffS3InputFormat extends S3InputFormat[TimeProjectedExtent, Tile] {
  def createRecordReader(split: InputSplit, context: TaskAttemptContext) =
    new TimeGeoTiffS3RecordReader(context)
}

class TimeGeoTiffS3RecordReader(context: TaskAttemptContext) extends S3RecordReader[TimeProjectedExtent, Tile] {
