...
object FocalOperation {
  ...
  def apply[K: GridComponent: ClassTag](rasterRDD: TileLayerRDD[K], neighborhood: Neighborhood)
...
abstract class FocalOperation[K: GridComponent: ClassTag] extends MethodExtensions[TileLayerRDD[K]] {
