...
object Pyramid extends Logging {
  ...
  def up[
    ...
    zoom: Int,
    resampleMethod: ResampleMethod): (Int, RDD[(K, V)] with Metadata[LayerMetadata[K]]) =
  ...
  def up[
    ...
    partitioner: Option[Partitioner]): (Int, RDD[(K, V)] with Metadata[LayerMetadata[K]]) = {
    ...
    val nextMetadata = LayerMetadata[K](
  ...
  def up[
    K: GridComponent: ClassTag,
    V <: CellGrid: ClassTag: ? => TileMergeMethods[V]: ? => TilePrototypeMethods[V]
  ](rdd: RDD[(K, V)] with Metadata[LayerMetadata[K]], layoutScheme: LayoutScheme, zoom: Int): (Int, RDD[(K, V)] with Metadata[LayerMetadata[K]]) =
  ...
  def upLevels[
    K: GridComponent: ClassTag,
    V <: CellGrid: ClassTag: ? => TileMergeMethods[V]: ? => TilePrototypeMethods[V]
  ](rdd: RDD[(K, V)] with Metadata[LayerMetadata[K]], layoutScheme: LayoutScheme, startZoom: Int, endZoom: Int, resampleMethod: ResampleMethod)
   (f: (RDD[(K, V)] with Metadata[LayerMetadata[K]], Int) => Unit): RDD[(K, V)] with Metadata[LayerMetadata[K]] =
  ...
  def upLevels[
   ...
   (f: (RDD[(K, V)] with Metadata[LayerMetadata[K]], Int) => Unit): RDD[(K, V)] with Metadata[LayerMetadata[K]] = {
    def runLevel(thisRdd: RDD[(K, V)] with Metadata[LayerMetadata[K]], thisZoom: Int): (RDD[(K, V)] with Metadata[LayerMetadata[K]], Int) =
      if (thisZoom > endZoom) {
        f(thisRdd, thisZoom)
  ...
  def upLevels[
    K: GridComponent: ClassTag,
    V <: CellGrid: ClassTag: ? => TileMergeMethods[V]: ? => TilePrototypeMethods[V]
  ](rdd: RDD[(K, V)] with Metadata[LayerMetadata[K]], layoutScheme: LayoutScheme, startZoom: Int, endZoom: Int)
   (f: (RDD[(K, V)] with Metadata[LayerMetadata[K]], Int) => Unit): RDD[(K, V)] with Metadata[LayerMetadata[K]] =
  ...
  def upLevels[
    K: GridComponent: ClassTag,
    V <: CellGrid: ClassTag: ? => TileMergeMethods[V]: ? => TilePrototypeMethods[V]
  ](rdd: RDD[(K, V)] with Metadata[LayerMetadata[K]], layoutScheme: LayoutScheme, startZoom: Int, resampleMethod: ResampleMethod)
   (f: (RDD[(K, V)] with Metadata[LayerMetadata[K]], Int) => Unit): RDD[(K, V)] with Metadata[LayerMetadata[K]] =
  ...
  K: GridComponent: ClassTag,
  V <: CellGrid: ClassTag: ? => TileMergeMethods[V]: ? => TilePrototypeMethods[V]
  ](rdd: RDD[(K, V)] with Metadata[LayerMetadata[K]], layoutScheme: LayoutScheme, startZoom: Int)
   (f: (RDD[(K, V)] with Metadata[LayerMetadata[K]], Int) => Unit): RDD[(K, V)] with Metadata[LayerMetadata[K]] =
